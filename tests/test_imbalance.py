...
class TestFindFairValueGaps:
    ...
    def test_find_fair_value_gaps_detects_bullish_fvg(self, bullish_fvg_data):
        ...
        bullish, bearish = find_fair_value_gaps(
            bullish_fvg_data["high"],
            bullish_fvg_data["low"],
    ...
    def test_find_fair_value_gaps_detects_bearish_fvg(self, bearish_fvg_data):
        ...
        bullish, bearish = find_fair_value_gaps(
            bearish_fvg_data["high"],
            bearish_fvg_data["low"],
            min_gap_percent=0.001
        )
    ...
    def test_min_gap_percent_filters_small_gaps(self):
        ...
        bullish_strict, _ = find_fair_value_gaps(
            data["high"],
            data["low"],
        ...
        bullish_lenient, _ = find_fair_value_gaps(
            data["high"],
            data["low"],
            min_gap_percent=0.0001
        )
...
class TestGetActiveFVGs:
    ...
    def test_get_active_fvgs_respects_max_age(self):
        ...
        active_no_filter = get_active_fvgs(
            fvg_zones,
            dates[80],
            max_age_bars=None
        )
        ...
        active_filtered = get_active_fvgs(
            fvg_zones,
            dates[80],
            max_age_bars=20
        )
